 ...
 * coming from nums1.
 */
public class MergeTwoOrderedArraysInArray1 {
    ...
    public void merge(int[] nums1, int m, int[] nums2, int n) {
        ...
        System.out.println("Initial Array1: " + Arrays.toString(nums1));
        ...
        System.out.println("Merged Array1: " + Arrays.toString(nums1));
    }
}
